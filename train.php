...
$timetable = array(
	...
	array("code"=>"C3604","direct"=>"sh","stop"=>"y","day"=>"workday","starttime"=>"625"),
	array("code"=>"C3002","direct"=>"sh","stop"=>"n","day"=>"workday","starttime"=>"658"),
	array("code"=>"C3004","direct"=>"sh","stop"=>"n","day"=>"workday","starttime"=>"720"),
	...
	array("code"=>"C3024","direct"=>"sh","stop"=>"n","day"=>"workday","starttime"=>"1644"),
	array("code"=>"C3024","direct"=>"sh","stop"=>"n","day"=>"workday","starttime"=>"1710"),
	array("code"=>"C3024","direct"=>"sh","stop"=>"y","day"=>"workday","starttime"=>"1728"),
	...
	array("code"=>"C3024","direct"=>"sh","stop"=>"y","day"=>"workday","starttime"=>"2032"),
	array("code"=>"C3024","direct"=>"sh","stop"=>"y","day"=>"workday","starttime"=>"2107"),
	array("code"=>"C3024","direct"=>"sh","stop"=>"n","day"=>"workday","starttime"=>"2155"),
	...
	array("direct"=>"js","stop"=>"n","day"=>"workday","starttime"=>"1034"),
	...
	array("direct"=>"js","stop"=>"n","day"=>"workday","starttime"=>"1801"),
	...
	array("direct"=>"js","stop"=>"y","day"=>"workday","starttime"=>"2034"),
	array("direct"=>"js","stop"=>"y","day"=>"workday","starttime"=>"2110"),
	array("direct"=>"js","stop"=>"n","day"=>"workday","starttime"=>"2153"),
	...
	array("direct"=>"js","stop"=>"n","day"=>"weekend","starttime"=>"1801"),
	...
	array("direct"=>"js","stop"=>"y","day"=>"weekend","starttime"=>"2034"),
	array("direct"=>"js","stop"=>"y","day"=>"weekend","starttime"=>"2110"),
	array("direct"=>"js","stop"=>"n","day"=>"weekend","starttime"=>"2153"),
	...
	array("direct"=>"sh","stop"=>"y","day"=>"weekend","starttime"=>"2032"),
