    ...
    <div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>商户</h2>
                    <a href="/manage/partner/sync.php" target="_blank">同步至百度云存储</a>
                ...
                <div class="sect">
					...
					<tr><th width="40">ID</th><th width="320">名称</th><th width="60">分类</th><th width="120">联系人</th><th width="130">电话号码</th><th width="60">同步</th><th width="60">展示</th><th width="40">排序</th><th width="100">操作</th></tr>
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
						...
						<td nowrap><?php echo $one['longlat_sync']; ?></td>
