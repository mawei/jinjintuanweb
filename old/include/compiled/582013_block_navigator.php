...
<!--{/if}--> 
<?php if(option_yes('usercredit')){?><li><a id="nav_2" href="/credit/creditshop.php" <?php if($pagetitle=='积分商城'){?>class="current"<?php }?>><span>积分商城</span></a></li><?php }?> 
...
<?php if(option_yes('navseconds')){?><li><a id="nav_4" href="/team/seconds.php" <?php if($pagetitle=='秒杀抢团'){?>class="current"<?php }?>><span>秒杀抢团</span></a></li><?php }?> 
...
<?php if(option_yes('navforum')){?><li><a id="nav_7" href="/forum/index.php" <?php if($pagetitle=='讨论区'){?>class="current end"<?php }?>><span>讨论区</span></a></li><?php }?> 
<?php if(option_yes('navcomment')){?><li><a href="/team/comments.php" <?php if($pagetitle=='买家点评'){?>class="current"<?php }?>><span>买家点评</span></a></li><?php }?> 
