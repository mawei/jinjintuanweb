   ...
   ; ?>
    ...
    <div style="position: static; top: 0px;" id="inner">  
      <ul class="xqlist c3" style="width:728px;">
         ...
         <li style="width:160px; float:right">
          ...
          <img src="/include/template/btn_buy.jpg" />
          </a>
          </li>
      </ul>
      <di</div>
...
<div id="ev56_main_side" class="tab_box">                
					...
					<!---<div class="deal-buy-bottom" style="clear: both;text-align:center; padding:30px;">
...
<div class="tab_box" style="display:none;"> 
		<iframe frameborder="0" scrolling="no" src="http://show.v.t.qq.com/index.php?c=show&a=index&n=im18ge&w=0&h=552&fl=2&l=30&o=31&co=0" width="100%" height="677"></iframe>				
</div>
<!---腾讯微博END-->	
<!--卖家点评STR-->	
...
<div class="rbox">
        ...
        <div>&nbsp;&nbsp;交通：<?php echo $partner['location']; ?></div>
</div>
        <!--今日其他团购-->
