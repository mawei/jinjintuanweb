  ...
  <div class="credit fcomment-list-box" style=" padding-top:1px;padding-bottom:1px;" >
			...
			<ul class="lcComment" id="items">
				...
				<li>
					...
					<div class="lcCont" style="background-image:url('<?php echo WEB_ROOT; ?>/static/theme/58/css/i/comment-icon-<?php echo $v['grade']; ?>.gif');">   <a href="/partner.php?id=<?php echo $v['partner_id']; ?>"><?php echo $v['comment']; ?></a></div>
					<div class="lcTime"> 
