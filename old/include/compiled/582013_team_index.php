...
#jqtgssb .btnrssa{background:url("/static/theme/58/css/i/buttonssb.gif") no-repeat scroll 0 0 transparent;width:75px;height: 26px;border:0 none;cursor: pointer;margin-top: 5px;}
...
.Wdate{background: url("/static/theme/58/css/i/datePicker.gif") no-repeat scroll right center #FFFFFF; border: 1px solid #A3DCEF;height: 24px;width: 120px;}
...
#sRlist .pic .soldout{position:absolute;z-index:1;right:0;bottom:0;_bottom:-1px;width:122px;height:69px;background-image: none;background:url("/static/theme/58/css/i/bg-deals-default-soldout.png") no-repeat 0 0;_background:transparent;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/static/theme/58/css/i/bg-deals-default-soldout.png");}
...
#sRlist .pic .isopen{position:absolute;z-index:1;right:-13px;bottom:-7px;width:65px;height:65px;background:url("/static/theme/58/css/i/bg-deals-default-isopen.png") no-repeat 0 0;_background:transparent;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/static/theme/58/css/i/bg-deals-default-isopen.png");}
...
#sRlist .pic .seconds_wait{position:absolute;z-index:1;right:-13px;bottom:-7px;width:65px;height:65px;background:url(/static/theme/58/css/i/bg-deals-seconds_wait.png) no-repeat 0 0;_background:transparent;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/static/theme/58/css/i/bg-deals-seconds_wait.png");}
...
#sRlist .pic .seconds_on{position:absolute;z-index:1;right:-13px;bottom:-7px;width:65px;height:65px;background:url(/static/theme/58/css/i/bg-deals-seconds_on.png) no-repeat 0 0;_background:transparent;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/static/theme/58/css/i/bg-deals-seconds_on.png");}
...
#sRlist .pic .seconds_off{position:absolute;z-index:1;right:-13px;bottom:-7px;width:65px;height:65px;background:url(/static/theme/58/css/i/bg-deals-seconds_off.png) no-repeat 0 0;_background:transparent;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/static/theme/58/css/i/bg-deals-seconds_off.png");}
						...
						<dd>
							...
							<p>
								现价：&yen;<b class="nprice"><?php echo moneyit($one['team_price']); ?></b><br>
																<span>原价：&yen;<?php echo moneyit($one['market_price']); ?>元</span><span>节省：&yen;<?php echo moneyit($one['market_price']-$one['team_price']); ?></span><span>折扣：<b><?php echo team_discount($one); ?></b>折</span><span>购买人数：<b><?php echo $one['now_number']; ?></b>人</span>
