		...
		<div class="box clear">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr><th width="50">ID</th><th width="250">中文名称</th><th width="250">英文名称</th><th width="60">首字母</th><th width="150"><?php if($zone=='group'){?>所属分类<?php } else if($zone=='area') { ?>所属城市<?php } else { ?>自定义分组<?php }?></th><th width="40" nowrap>导航</th><th width="40" nowrap>排序</th><th width="100">操作</th></tr>
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?>>
						...
						<td><?php if($zone=='group' || $zone == 'area'){?>
