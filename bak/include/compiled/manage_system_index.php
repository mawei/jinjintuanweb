            ...
            <div class="box-content">
                ...
                <div class="sect">
                    <form method="post">
                        ...
                        <div class="field">
							<label>网站描述</label>
							<input type="text" size="30" name="system[description]" class="f-input f-hint" value="<?php echo $INI['system']['description']; ?>"/>
						</div>
						<div class="field">
							<label>网站关键词</label>
							<input type="text" size="30" name="system[keywords]" class="f-input f-hint" value="<?php echo $INI['system']['keywords']; ?>"/>
						</div>
                        <div class="field">
                            <label>时区设置</label>
                        ...
                        <div class="field">
                            <label>客服QQ</label>
                            <input type="text" size="30" name="system[kefuqq]" class="f-input f-hint" value="<?php echo $INI['system']['kefuqq']; ?>"/><span class="inputtip">直接填写QQ号码,多个QQ号用逗号分开</span>
						</div>
                        <div class="field">
                            <label>阿里旺旺</label>
                            <input type="text" size="30" name="system[kefumsn]" class="f-input f-hint" value="<?php echo $INI['system']['kefumsn']; ?>"/><span class="inputtip">QQ,旺旺均可用逗号空格隔开多个帐户</span>
						</div>
						<div class="wholetip clear"><h3>4、其他信息</h3></div>
                        <div class="field">
                            <label>网站地址</label>
                            <input type="text" size="30" name="system[wwwprefix]" class="f-input f-hint" value="<?php echo $INI['system']['wwwprefix']; ?>"/><span class="inputtip">形如：http://www.yourname.com </span>
						</div>
                        <div class="field">
                            <label>图片前缀</label>
