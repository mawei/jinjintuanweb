...
<div id="partner">
	<div class="dashboard" id="dashboard">
		<ul><?php echo mcurrent_market('index'); ?></ul><li><a href="/manage/market/ad.php">广告设置</a><span></span></li></ul>
	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
				<div class="head"><h2>邮件营销</h2>
					<ul class="filter">
						<li class="current"><a href="/manage/market/index.php">邮件营销</a></li>
						<li><a href="/ajax/subscribe.php?action=mail"  class="ajaxlink">邮件订阅</a></li>
					</ul>	
				</div>
                <div class="sect">
