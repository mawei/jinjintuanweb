            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td><?php echo $option_delivery[$teams[$one['team_id']]['delivery']]; ?><?php echo ($one['express_id']&&$one['express_no'])?'Y':''; ?></td>
						<td class="op" nowrap><a href="/ajax/manage.php?action=orderremove&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="确定删除本订单？">删除</a>&nbsp;&nbsp;<a href="/ajax/manage.php?action=orderview&id=<?php echo $one['id']; ?>" class="ajaxlink">详情</a></td>
					</tr>
					<?php }}?>
