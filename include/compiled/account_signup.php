                ...
                <div class="sect">
                    <form id="signup-user-form" method="post" action="/account/signup.php" class="validator">
                       <div class="field">
                            ...
                            <input type="text" size="30" name="mobile" id="signup-mobile" class="number" require="<?php echo option_yes('needmobile')?'true':'require'; ?>" datatype="mobile|ajax" url="<?php echo WEB_ROOT; ?>/ajax/validator.php" vname="signupmobile" msg="手机号码不正确|手机号码已经被注册" /><span class="inputtip"></span>
                        	<button type="button" value="获取验证码" onclick="getcode();">获取验证码</button>
                        </div>
                        <div class="field ">
                            <label for="captcha_code">验证码</label>
                            <input type="text" size="30" name="captcha_code" id="captcha_code" class="f-input" require="true" datatype="require" />
                        </div>                        
