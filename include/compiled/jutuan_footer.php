<div id="ftw">
	<div id="ft">
		<p class="contact">咨询电话:029-88696371&nbsp;&nbsp;&nbsp;&nbsp;QQ官方群:56815125&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/feedback/suggest.php">意见反馈</a><a href="#top">＿Top↑</a></p>
		<ul class="cf">
			<li class="col">
				<h3>用户帮助</h3>
				<ul class="sub-list">
					...
					<li><a href="/help/repay.php">退款流程</a></li>
					<li><a href="/feedback/flinks.php">友情链接</a></li>
				</ul>
			</li>
			<li class="col">
				<h3>关注聚团吧</h3>
			...
			<li class="col">
				...
				<ul class="sub-list">
					...
					<li><a href="/help/xydl.php">校园代理</a></li>
					<li><a href="/help/runzi.php">招股募资</a></li>
		...
		<div class="copyright">
		<p>CopyRight&copy;<span>2010</span>&nbsp;<?php echo $INI['system']['sitename']; ?>(Jutuanba.com)版权所有(支持雕鹰团队：bbs.diaoying.com)&nbsp;<a href="/about/terms.php">使用<?php echo $INI['system']['abbreviation']; ?>前必读</a>&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $INI['system']['icp']; ?></a>&nbsp;Powered by <a href="http://www.juzweb.net/" target="_blank">JuzWeb</a> software.
...
<script src="/static/js/base_min.js" charset="GBK"></script>
<script src="/static/js/chatroom_min.js" charset="GBK"></script>
<script type="text/javascript" charset="GBK">var wuc_chatroom = new WUCChatroom({id: 501516, name: '聚团吧', siteApi : ''});</script>
